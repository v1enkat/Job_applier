...
def validate_personals() -> None | ValueError | TypeError:
    ...
    check_string(permanent_street, "permanent_street")
    check_string(permanent_city, "permanent_city")
    check_string(permanent_state, "permanent_state")
    check_string(permanent_zipcode, "permanent_zipcode")
    check_string(permanent_address_full, "permanent_address_full")
    
    check_string(ethnicity, "ethnicity", ["Decline", "Hispanic/Latino", "American Indian or Alaska Native", "Asian", "Indian", "Black or African American", "Native Hawaiian or Other Pacific Islander", "White", "Other"],  min_length=0)
...
def validate_questions() -> None | ValueError | TypeError:
    ...
    check_int(months_of_experience, "months_of_experience")
...
def validate_search() -> None | ValueError | TypeError:
    ...
    check_boolean(enforce_india_salary_rules, "enforce_india_salary_rules")
    check_int(min_fulltime_ctc_lpa, "min_fulltime_ctc_lpa", 1)
    check_int(min_internship_stipend_inr, "min_internship_stipend_inr", 0)
